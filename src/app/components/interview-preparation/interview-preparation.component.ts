...
export class InterviewPreparationComponent implements OnInit {
  ...
  // Your 6 interview sets (simplified)
  interviewSets: InterviewSet[] = [
    ...
    {
      id: 3,
      title: "Full Stack Developer Interview - MNC Company",
      company: "MNC Company",
      date: "January 2025",
      totalQuestions: 10,
      questions: [
  ...
  // Helper methods for interview sets
  getSetCategories(set: InterviewSet): string[] {
    // If the set has questions, extract categories from them
    ...
    // Fallback to predefined categories for sets without detailed questions
    const categoryMap: { [key: number]: string[] } = {
      1: ['Angular', 'RxJS', 'Performance', 'Testing'],
      2: ['Angular', 'RxJS', 'HTML', 'JavaScript', 'APIs'],
      3: ['Angular', 'Performance', 'JavaScript', 'CSS', 'Bootstrap'],
      4: ['Angular', 'JavaScript', 'Algorithms'],
      5: ['TypeScript', 'Angular', 'RxJS', 'Testing', 'Algorithms'],
      6: ['RxJS', 'Testing', 'Security', 'Performance']
    };
    return categoryMap[set.id] || ['General'];
  }
