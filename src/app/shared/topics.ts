...
export const listOfQuestions: InterviewTopic[] = [
  ...
  { name: 'Currying', category: 'javascript', difficulty: 'easy', showDescription: false },
  { name: 'comparision-operators', category: 'javascript', difficulty: 'easy', showDescription: false },
  { name: 'array-methods', category: 'javascript', difficulty: 'easy', showDescription: false },
